    ...
    <div class="bg-white rounded-xl shadow p-6">
      <!-- <form @submit.prevent="submitCategory">
        ...
        <div class="mb-6">
            ...
            <select v-model="formData.parent_id" class="mt-1 block w-full pl-3 pr-[20px] py-2 border-gray-300 rounded-md p-2.5 border">
        ...
        <div class="mb-4">
          ...
          <input type="text" v-model="formData.name" class="mt-1 block w-full rounded-md border-gray-300 p-2.5 border" placeholder="e.g. Electronics" />
        </div>
