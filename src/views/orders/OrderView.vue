	    ...
	    <div class="bg-white rounded-xl shadow p-6">
	      	...
	      	<div class="mx-auto space-y-6">
	      		<Accordion v-if="orders.length > 0" multiple>
	      			<AccordionPanel v-for="order in orders" :key="order.id" :value="order.id.toString()" class="bg-white rounded-2xl shadow-sm border border-slate-200 overflow-hidden hover:shadow-md transition-shadow duration-300 mb-4 mt-4">
	      				<AccordionHeader>
		      				<div class="w-full">
		        	...
		        	<div v-if="orders.length" class="mt-4 flex justify-end">
